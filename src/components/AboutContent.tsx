...
export default function AboutContent({activeIndex}: Props) {
    return (
        <article className="about-content">
            <div className={`content${activeIndex===0 ? ' active' : ''}`} id="history">
                <h4>history</h4>
                <p>
            ...
            <div className={`content${activeIndex===1 ? ' active' : ''}`} id="vision">
                <h4>vision</h4>
                <p>
            ...
            <div className={`content${activeIndex===2 ? ' active' : ''}`} id="goals">
                <h4>goals</h4>
                <p>
